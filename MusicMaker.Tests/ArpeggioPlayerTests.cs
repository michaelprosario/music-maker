...
namespace MusicMaker.Tests
{
    ...
    public class ArpeggioPlayerTests
    {
        ...
        public void ArpeggioPlayer__Arp2Test()
        {
            ...
            var track = new ChordPlayerTrack(instrument, channel, tempo);
            var track2 = new ChordPlayerTrack(instrument, channel, tempo);
            var track3 = new ChordPlayerTrack(instrument, channel, tempo);
            ...
            var chordChanges = YourGraceIsEnoughChords();
