...
export class MusicMakerClient {
    ...
    makeDrumTrack(command: MakeDrumTrackCommand): Observable<MakeDrumTrackResponse> {
        let url_ = this.baseUrl + "/api/MusicMaker/v1/MakeDrumTrack";
        url_ = url_.replace(/[?&]$/, "");
    ...
    makeMidiFromArpeggio(command: MakeMidiFromArpeggioCommand): Observable<CommonResponse> {
        let url_ = this.baseUrl + "/api/MusicMaker/v1/MakeMidiFromArpeggio";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processMakeMidiFromArpeggio(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processMakeMidiFromArpeggio(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CommonResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CommonResponse>;
        }));
    }

    protected processMakeMidiFromArpeggio(response: HttpResponseBase): Observable<CommonResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CommonResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class CommonResponse implements ICommonResponse {
    ...
    constructor(data?: ICommonResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CommonResponse {
        data = typeof data === 'object' ? data : {};
...
export class MakeDrumTrackResponse extends CommonResponse implements IMakeDrumTrackResponse {
    ...
    static override fromJS(data: any): MakeDrumTrackResponse {
        data = typeof data === 'object' ? data : {};
...
export interface IMakeDrumTrackResponse extends ICommonResponse {
}
...
export class MakeArpeggioPatternCommand implements IMakeArpeggioPatternCommand {
    pattern!: ArpeggioPattern;
    beatsPerMinute!: number;
    channel!: number;
    userId!: string;

    constructor(data?: IMakeArpeggioPatternCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (!data) {
            this.pattern = new ArpeggioPattern();
        }
    }

    init(_data?: any) {
        if (_data) {
            this.pattern = _data["pattern"] ? ArpeggioPattern.fromJS(_data["pattern"]) : new ArpeggioPattern();
            this.beatsPerMinute = _data["beatsPerMinute"];
    ...
    static fromJS(data: any): MakeArpeggioPatternCommand {
        data = typeof data === 'object' ? data : {};
        let result = new MakeArpeggioPatternCommand();
        result.init(data);
        return result;
    }
...
export interface IMakeArpeggioPatternCommand {
    pattern: ArpeggioPattern;
    beatsPerMinute: number;
    channel: number;
    userId: string;
...
export class MakeMidiFromArpeggioCommand extends MakeArpeggioPatternCommand implements IMakeMidiFromArpeggioCommand {
    ...
    constructor(data?: IMakeMidiFromArpeggioCommand) {
        super(data);
        if (!data) {
            this.chordChanges = [];
        }
    ...
    override init(_data?: any) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["chordChanges"])) {
                this.chordChanges = [] as any;
                for (let item of _data["chordChanges"])
                    this.chordChanges!.push(ChordChange.fromJS(item));
            }
            this.chordChangesAsString = _data["chordChangesAsString"];
        }
    }

    static override fromJS(data: any): MakeMidiFromArpeggioCommand {
        data = typeof data === 'object' ? data : {};
        let result = new MakeMidiFromArpeggioCommand();
        result.init(data);
        return result;
    }
    ...
    override toJSON(data?: any) {
        ...
        if (Array.isArray(this.chordChanges)) {
            data["chordChanges"] = [];
            for (let item of this.chordChanges)
                data["chordChanges"].push(item.toJSON());
        }
...
export class ChordChange implements IChordChange {
    beatCount!: number;
    chordRoot!: number;
    chordType!: ChordType;

    constructor(data?: IChordChange) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.beatCount = _data["beatCount"];
            this.chordRoot = _data["chordRoot"];
            this.chordType = _data["chordType"];
        }
    }

    static fromJS(data: any): ChordChange {
        data = typeof data === 'object' ? data : {};
        let result = new ChordChange();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["beatCount"] = this.beatCount;
        data["chordRoot"] = this.chordRoot;
        data["chordType"] = this.chordType;
        return data;
    }
}

export interface IChordChange {
    beatCount: number;
    chordRoot: number;
    chordType: ChordType;
}
...
export class ArpeggioPattern implements IArpeggioPattern {
    ...
    static fromJS(data: any): ArpeggioPattern {
        data = typeof data === 'object' ? data : {};
        let result = new ArpeggioPattern();
        result.init(data);
        return result;
    }
...
export class ArpeggioPatternRow implements IArpeggioPatternRow {
    octave!: number;
    type!: ArpeggioPatternRowType;
    pattern!: string;

    constructor(data?: IArpeggioPatternRow) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.octave = _data["octave"];
            this.type = _data["type"];
            this.pattern = _data["pattern"];
        }
    }

    static fromJS(data: any): ArpeggioPatternRow {
        data = typeof data === 'object' ? data : {};
        let result = new ArpeggioPatternRow();
        result.init(data);
        return result;
    }
...
export interface IArpeggioPatternRow {
    octave: number;
    type: ArpeggioPatternRowType;
    pattern: string;
}
